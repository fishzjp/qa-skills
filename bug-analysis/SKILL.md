...
- **Root Cause**: {根因结论 + status 标注：Inference（读代码推断）/ Verified（已复现验证 E3）}
- **Evidence**: {证据链：复现日志/截图 + 根因代码 `文件:行`，等级标注见 `../core/evidence.md`}
...
- Severity 按后果分级：数据丢失/资损/安全 → P0；核心功能不可用 → P0/P1；部分降级 → P1；体验问题 → P2
