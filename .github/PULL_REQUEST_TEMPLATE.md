...
- [ ] `python3 scripts/validate_skills.py` 通过（完整自检枚举见 [CONTRIBUTING 提交前自检](./CONTRIBUTING.md#提交前自检)：frontmatter / description ≤300 字符 / SKILL.md ≤500 行 / When NOT to Use / core 依赖单元声明 / 引用完整含 md 链接与引用式定义 / 无跨 skill 引用 / 版本一致 / JSON 合法 / 无 eval 越界引用 / 跟踪面白名单 / skills 目录形态）
